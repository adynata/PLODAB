...
(function(){
  ...
  dataSets.locations = [
          {name: "Fort Lauderdale, Florida", count: 1},
          {name: "Los Angeles", count: 1},
          {name: "Santa Cruz, Calif.", count: 100},
          {name: "Burlington, Vt.", count: 1},
          {name: "Rosendale, N.Y.", count: 1},
          {name: "Mexico, D.F.", count: 1},
          {name: "Illinois?", count: 1},
          {name: "Brooklyn", count: 1},
          {name: "New Haven, Conn.?", count: 1},
          {name: "Washington, DC?", count: 1},
          {name: "Pittsburgh, Penn.", count: 1},
          {name: "Wilmington, DE", count: 1},
          {name: "El Cerrito, Calif.", count: 1},
          {name: "North Bay, Ont.", count: 1},
