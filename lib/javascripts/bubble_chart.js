...
(function(){
  ...
  Bubbles = function() {
    ...
    var chart, chartSale, clear, click, collide, collisionPadding, connectEvents, data, force, gravity, hashchange, height, idValue, jitter, label, margin, maxRadius, minCollisionRadius, mouseout, mouseover, node, rScale, rValue, textValue, tick, transformData, update, updateActive, updateLabels, updateNodes, width;
    ...
    chart = function(selection) {
      return selection.each(function(rawData) {
        ...
        var maxDomainValue, svg, svgEnter, totalArea;
        ...
        maxDomainValue = d3.max(data, function(d) {
          totalArea += (Math.pow(rValue(d), 2) * Math.PI );
    ...
    root.plotData = function(selector, data, plot) {
      ...
      var bubbleChart = d3.select(selector).datum(data).call(plot);
      console.log(bubbleChart[0]);
    };
