...
function parseData(xml) {
  ...
  function fetchSubjects(key) {
    ...
    function logCulturalContext(value) {
      ...
      if (culturalContextStore[upcaseCulturalContext]) {
        ...
        culturalContextStore[upcaseCulturalContext] = {topic: "place_of_publication", name: upcaseCulturalContext, count: 1};
      }
    }
  ...
  Object.keys(culturalContextStore).forEach(makePlaceOfPublicationBubbleChartData);

  // makeTimelineData();

  // console.log("artifacts", artifacts);
  // console.log("subjects", Object.keys(subjectsStore));
  // console.log("techniques", Object.keys(techniquesStore));
  // console.log("materials", Object.keys(materialsStore));
  // console.log("culturalContext", culturalContextStore);
  ...
  function makePlaceOfPublicationBubbleChartData(key, store) {
    // TODO: set this part up to run on page load
    // console.log(culturalContextStore[key]);

    dataSets.place_of_publication.push(culturalContextStore[key]);
  }
